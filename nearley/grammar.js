...
var grammar = {
    ...
    {"name": "main", "symbols": ["_", {"literal":"="}, "_", "S", "_"], "postprocess": function(d) {return {type:'main', d:d, v:d[3].v}}},
    ...
    {"name": "S", "symbols": ["S$subexpression$1", "_", {"literal":"("}, "_", "string", "_", {"literal":")"}], "postprocess": function(d) {return {type:'parentprop', d:d, v:parentProp(d[4])}}},
