...
var grammar = {
    ...
    {"name": "SP", "symbols": [{"literal":"("}, "_", "SC", "_", {"literal":")"}], "postprocess": function(d) {return {type:'SP', d:d, v:d[2].v}}},
    ...
    {"name": "SC", "symbols": ["SC", "_", {"literal":"&"}, "_", "S"], "postprocess": function(d) {return {type:'SC', d:d, v:d[0].v+d[4].v}}},
    {"name": "SC", "symbols": ["AS", "_", {"literal":"&"}, "_", "S"], "postprocess": function(d) {return {type:'SC', d:d, v:d[0].v+d[4].v}}},
    ...
    {"name": "S", "symbols": ["S$subexpression$1", "_", {"literal":"("}, "_", "SC", "_", {"literal":")"}], "postprocess": function(d) {return {type:'parentprop', d:d, v:d[4].v}}},
